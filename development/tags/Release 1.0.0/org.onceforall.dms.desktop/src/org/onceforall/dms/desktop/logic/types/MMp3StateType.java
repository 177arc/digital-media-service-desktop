...
public class MMp3StateType extends StateType {
    /** Specifies the text that represents the published state. */
    public static final State PUBLISHED_STATE = State.get("Published", new File("Image Files\\Published.gif"));
    
    /** Specifies the text that represents the state indicating that the MP3 should be published with the next publishing run. */
    public static final State TO_BE_PUBLISHED_STATE = State.get("To be published", null);
    
    /** Specifies the text that represents the state indicating that the MP3 will not be included in any future publishing runs. */
    public static final State NOT_PUBLISHED_STATE = State.get("Not published", null);
    
    /** Specifies the text that represents the state indicating that the MP3 will not be included in any future publishing runs and that the MP3 files have been removed from their orginial location. */
	...
	protected MMp3StateType() {
		super("MP3 state", "Specifies the states that an MP3 can have.", new State[] { PUBLISHED_STATE, 
				TO_BE_PUBLISHED_STATE, NOT_PUBLISHED_STATE, ARCHIVED_STATE});
	}
