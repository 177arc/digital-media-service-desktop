/*
 * Revision History
 * $Log: MObjectItemProvider.java,v $
...
/**
 * This is the item provider adapter for a {@link org.onceforall.dms.desktop.logic.MObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MObjectItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LogicPackage.Literals.MOBJECT__MNAME_PROPERTY);
			childrenFeatures.add(LogicPackage.Literals.MOBJECT__MDESCRIPTION_PROPERTY);
			childrenFeatures.add(LogicPackage.Literals.MOBJECT__MICON_FILE_PATH_PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((MObject)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MObject_type") :
