...
public class MElementTreeSelectorComposite extends MElementComposite implements MElementSelector {
	...
	public MElementTreeSelectorComposite(Composite parent, int style) {
		...
		tree.addMouseTrackListener(new MouseTrackAdapter() {
			...
			public void mouseExit(MouseEvent event) {
				...
				if(tree.getClientArea().contains(mousePosition))
					return;
	...
	protected void layoutMElementButtons() {
		...
		Rectangle buttonsArea = new Rectangle(Math.min(treeItemBounds.x+treeItemBounds.width+BUTTON_SPACING, clientArea.width-visibleButtonsWidth-BUTTON_SPACING*2),
