...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>MManual Task Step</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.onceforall.dms.desktop.logic.LogicPackage#getMManualTaskStep()
 * @model kind="class"
 *        annotation="http://www.onceforall.org/mcore name='Manual task' description='Marks a manual task as completed. This task does not perform any automated actions.' actionName='Mark as completed' actionIconFilePath='Image Files\\Mark as completed.gif' interruptable='false' stoppable='false' terminatable='false'"
 * @generated
 */
public class MManualTaskStep extends MStep {
	/**
	 ...
	 * @generated
	 */
	public static final String TYPE_NAME = MManualTaskStep.class.getName();
	 ...
	 */	
	static {
		Type.VALUE_TYPES_BY_NAME.put("Reference to "+MManualTaskStep.TYPE_NAME, new ReferenceType("Reference to "+MManualTaskStep.TYPE_NAME, "Specifies a reference to a "+MManualTaskStep.TYPE_NAME_FOR_UI, MManualTaskStep.class));
	}
	...
	public String getDefaultDescription() {
		return "Marks a manual task as completed. This task does not perform any automated actions.";
	}
	 ...
	 * @generated
	 */
	protected MManualTaskStep() {
		super();
		
		firstMManualTaskStepConstructorHook();
		...
		lastMManualTaskStepConstructorHook();		
	}
	 ...
	 * @generated
	 */
	private void firstMManualTaskStepConstructorHook() {
	 ...
	 * @generated
	 */
	private void lastMManualTaskStepConstructorHook() {
		// Does nothing by default. Remove the @generated tag to provide an implementation for this method.
	}
	...
	protected EClass eStaticClass() {
		return LogicPackage.Literals.MMANUAL_TASK_STEP;
	}
