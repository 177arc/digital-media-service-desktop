/*
 * Revision History:
 * $Log: EcoreModelGenerator.java,v $
...
public class EcoreModelGenerator { 
  ...
  protected final String TEXT_4 = "\" defaultValueLiteral=\"\"" + NL + "\t      containment=\"true\" resolveProxies=\"false\">" + NL + "\t     <eAnnotations source=\"http://www.onceforall.org/mcore\">" + NL + "\t       <details key=\"name\" value=\"";
 ...
 try { 
    ...
    stringBuffer.append(UTILITY.encodeForXml(mStepType.getDefaultActionName()));
