...
import org.onceforall.dms.desktop.logic.provider.LogicItemProviderAdapterFactory;


/**
 * This is an example of a Logic model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicEditor
	 ...
	 * @generated
	 */
	public static final List FILE_EXTENSION_FILTERS = prefixExtensions(LogicModelWizard.FILE_EXTENSIONS, "*.");
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(LogicEditor.this);
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(LogicEditor.this, false);
			}
			else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "org.onceforall.dms.desktop.editor",
					 0,
					 null,
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new LogicItemProviderAdapterFactory());
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					public void setSelectionToViewer(List selection) {
						LogicEditor.this.setSelectionToViewer(selection);
						LogicEditor.this.setFocus();
					}
	...
	public void doSaveAs() {
		...
		String[] files = DMSDesktopEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return DMSDesktopEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return DMSDesktopEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
