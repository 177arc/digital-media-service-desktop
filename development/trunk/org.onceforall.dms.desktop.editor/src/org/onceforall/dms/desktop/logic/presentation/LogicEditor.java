...
public class LogicEditor
	...
	public void doSaveAs() {
		String fileExtension = getString("_UI_LogicEditorFilenameExtension");
		String file = DMSDesktopEditorAdvisor.openFilePathDialog(getSite().getShell(), "*." + fileExtension, SWT.SAVE);
		if (file != null) {
