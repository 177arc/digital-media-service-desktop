...
<html>
<head>
<title>Christ Church Bromley - WordWiseXtra recordings</title>
<link href="wwx-recordings.xml" rel="alternate" type="application/rss+xml" title="Christ Church Bromley - WordWiseXtra recordings" />
<STYLE type="text/css">
...
?>
        ...
        <tr> 
          ...
          <td valign="top" width="500"> 
            <p class="heading">WordWiseXtra recordings</p>
            <p class="paragraph">The following recordings 
            of recent WordWiseXtra recordings are available for download or streaming in MP3 format.</p>
            <p class="paragraph"><span style="text-decoration:blink;font-weight:bold">New!</span> The recordings are now also available as iTunes podcast (search for "Bromley") and <a href="wwx-recordings.xml"><img src="rss_feed.gif" alt="RSS feed"></img></a> RSS news feed.</p>
