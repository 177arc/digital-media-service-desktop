 ...
 * </copyright>
 *
 * $Id: MetaModellerEditorAdvisor.java,v 1.1 2006/08/29 01:00:14 marc Exp $
 */
...
import org.onceforall.metamodeller.presentation.MetaModellerEditorPlugin;
 ...
 * @generated
 */
public final class MetaModellerEditorAdvisor extends WorkbenchAdvisor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	private static String getString(String key) {
		return MetaModellerEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return org.onceforall.metamodeller.presentation.MetaModellerEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
	}
	...
	public static class Application implements IPlatformRunnable {
		...
		public Object run(Object args) {
			WorkbenchAdvisor workbenchAdvisor = new MetaModellerEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "org.onceforall.metamodeller.presentation.MetaModellerEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the MetaModeller model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the MetaModeller model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static String openFilePathDialog(Shell shell, String fileExtensionFilter, int style) {
		...
		if (fileExtensionFilter == null) {
			fileExtensionFilter = "*." + getString("_UI_MetaModellerEditorFilenameExtension");
		}
	...
	public static boolean openEditor(IWorkbench workbench, URI fileURI) {
		...
		if (editorDescriptor == null) {
			MessageDialog.openError(workbenchWindow.getShell(), getString("_UI_Error_title"), getString("_WARN_No_Editor", fileURI.toFileString()));
			return false;
		} else {
			try {
