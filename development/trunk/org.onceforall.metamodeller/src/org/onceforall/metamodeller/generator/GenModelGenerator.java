...
public class GenModelGenerator { 
  ...
  protected final String TEXT_34 = "#//MObject/fixedMProperties\"/>" + NL + "      <genFeatures property=\"None\" notify=\"false\" createChild=\"false\" propertyCategory=\"\"" + NL + "          propertySortChoices=\"true\" ecoreFeature=\"ecore:EReference core.ecore#//MObject/fixedMSteps\"/>" + NL + "    </genClasses>" + NL + "    <genClasses image=\"false\" ecoreClass=\"";
  ...
  protected final String TEXT_41 = "#//MElement/descriptionForUI\"/>" + NL + "      <genFeatures createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  ...
  protected final String TEXT_55 = "#//MStep/fixedMParameters\"/>" + NL + "      <genFeatures property=\"None\" notify=\"false\" createChild=\"false\" propertySortChoices=\"true\"" + NL + "          ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_56 = "#//MStep/fixedMResults\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  ...
  protected final String TEXT_67 = "#//MStep/actionName\"/>" + NL + "      <genFeatures createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_68 = "#//MStep/actionIconFilePath\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_69 = "#//MStep/exception\"/>" + NL + "    </genClasses>" + NL + "    <genClasses image=\"false\" ecoreClass=\"";
  protected final String TEXT_70 = "#//MValue\">" + NL + "      <genFeatures notify=\"false\" children=\"true\" createChild=\"true\" propertySortChoices=\"true\"" + NL + "          ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_71 = "#//MValue/mInputValues\"/>" + NL + "      <genFeatures createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_72 = "#//MValue/valueForUI\"/>" + NL + "      <genFeatures property=\"None\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_73 = "#//MValue/value\"/>" + NL + "      <genFeatures property=\"None\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_74 = "#//MValue/historicValues\"/>" + NL + "      <genFeatures createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_75 = "#//MValue/historicValuesForUI\"/>" + NL + "      <genFeatures createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_76 = "#//MValue/readOnly\"/>" + NL + "    </genClasses>" + NL + "    <genClasses image=\"false\" ecoreClass=\"";
  protected final String TEXT_77 = "#//MApplication\">" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"false\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_78 = "#//MApplication/mDataFileProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_79 = "#//MApplication/dataFileProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_80 = "#//MApplication/dataFilePropertyHistoricValues\"/>" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"false\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_81 = "#//MApplication/mLogFileProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_82 = "#//MApplication/logFileProperty\"/>" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"false\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_83 = "#//MApplication/mPathProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_84 = "#//MApplication/pathProperty\"/>" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"false\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_85 = "#//MApplication/mVersionProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" propertyCategory=\"\" ecoreFeature=\"ecore:EAttribute ";
  protected final String TEXT_86 = "#//MApplication/versionProperty\"/>" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"false\" ecoreFeature=\"ecore:EReference core.ecore#//MDmsApplication/MLastSaveProperty\"/>" + NL + "      <genFeatures property=\"Readonly\" createChild=\"false\" ecoreFeature=\"ecore:EAttribute core.ecore#//MDmsApplication/lastSaveProperty\"/>" + NL + "    </genClasses>" + NL + "    <genClasses ecoreClass=\"";
  protected final String TEXT_87 = "#//MScript\">" + NL + "      <genFeatures property=\"None\" children=\"true\" createChild=\"true\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_88 = "#//MScript/mSteps\"/>" + NL + "    </genClasses>";
  protected final String TEXT_89 = NL + "    <genDataTypes ecoreDataType=\"";
  protected final String TEXT_90 = "#";
  protected final String TEXT_91 = "\"/>";
  protected final String TEXT_92 = NL + "    <genDataTypes ecoreDataType=\"";
  protected final String TEXT_93 = "#";
  protected final String TEXT_94 = "\"/>";
  protected final String TEXT_95 = NL + "    <genDataTypes ecoreDataType=\"";
  protected final String TEXT_96 = "#";
  protected final String TEXT_97 = "\"/>";
  protected final String TEXT_98 = NL + "    <genDataTypes ecoreDataType=\"";
  protected final String TEXT_99 = "#";
  protected final String TEXT_100 = "\"/>";
  protected final String TEXT_101 = NL + "    <genClasses ecoreClass=\"";
  protected final String TEXT_102 = "#";
  protected final String TEXT_103 = "\">";
  protected final String TEXT_104 = NL + "       <genFeatures property=\"None\" createChild=\"true\" children=\"true\" ecoreFeature=\"ecore:EReference ";
  protected final String TEXT_105 = "#";
  protected final String TEXT_106 = "\"/>";
  protected final String TEXT_107 = NL + "    </genClasses>";
  protected final String TEXT_108 = NL + "    <genClasses ecoreClass=\"";
  protected final String TEXT_109 = "#";
  protected final String TEXT_110 = "\">";
  protected final String TEXT_111 = NL + "    </genClasses>";
  protected final String TEXT_112 = NL + "  </genPackages>" + NL + "</genmodel:GenModel>";
 ...
 try { 
    ...
    stringBuffer.append(mStepType.getEcoreXPath());
